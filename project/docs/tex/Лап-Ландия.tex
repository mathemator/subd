...
\begin{document}
    ...
    \input{chapters/3-обоснование-и-нормализация}


    \section{Наполнение данными}\label{sec:datafilling}
    \input{chapters/4-наполнение-данными}


    \section{Кластер Patroni и настройки узлов БД}\label{sec:patronicluster}
    \input{chapters/5-кластер-patroni-и-настройки-узлов-бд}


    \section{Мониторинг}\label{sec:monitoring}
    \input{chapters/6-мониторинг}
